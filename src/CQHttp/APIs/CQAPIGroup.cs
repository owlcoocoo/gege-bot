...
namespace CQHttp
{
    public static class CQAPIGroup
    {
        ...
        /// <param name="user_id">QQ 号</param>
        /// <param name="no_cache">是否不使用缓存（使用缓存可能更新不及时, 但响应更快）</param>
        public static async Task<CQGroupMemberInfo> Group_GetGroupMemberInfoAsync(this CQBot bot, long group_id, long user_id, bool no_cache = false)
        {
        ...
        /// <param name="user_id">QQ 号</param>
        /// <param name="no_cache">是否不使用缓存（使用缓存可能更新不及时, 但响应更快）</param>
        public static async Task<CQGroupInfo[]> Group_GetGroupListAsync(this CQBot bot, bool no_cache = false)
        {
